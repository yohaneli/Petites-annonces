  ...
  <body>
    <div class="container">
        <div class="row justify-content-md-center">
            ...
            <div class="col-12">
            <br><br>
                <h1 class="text-align: center">Ajouter une nouvelle annonce</h1>
                    <br>
                ...
                <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="InputForName" class="form-label">Titre de l'annonce</label>
                            <input type="text" name="titre" class="form-control" id="InputForName" >
                    </div>

                    <div class="mb-3">
                        <label for="InputForName" class="form-label">Description de l'annonce</label>
                            <input type="text" name="description" class="form-control" id="InputForName" >
                    </div>
                    ...
                    <div class="mb-3">
                        <label for="InputForName" class="form-label">Prix de l'annonce</label>
                            <input type="number" name="prix" class="form-control" id="InputForName" >
                    </div>
